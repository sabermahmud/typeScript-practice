...
var BkashAcc = /** @class */ (function () {
    function BkashAcc(bkashNumber, bkashPin, bkashBalance, bkashUser) {
        this.bkashNumber = bkashNumber;
        this.bkashPin = bkashPin;
        this.bkashBalance = bkashBalance;
        this.bkashUser = bkashUser;
    }
    BkashAcc.prototype.getInfo = function () {
        return this.bkashBalance;
    };
    BkashAcc.prototype.giveProfit = function () {
        var profitMargin = (this.bkashBalance / 100) * 7;
        return this.bkashBalance + profitMargin;
    };
    return BkashAcc;
}());
var acc1Info = new BkashAcc(8801606093319, 91196, 1200, "Saber");
var acc2Info = new BkashAcc(8801404599090, 12345, 1300, "Tamanna");
